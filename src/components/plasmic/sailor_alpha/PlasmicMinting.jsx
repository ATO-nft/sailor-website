...
import sty from "./PlasmicMinting.module.css"; // plasmic-import: GeHxaxYhV01/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: QQ0SctFdkn5/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: boz120LRHfd/icon

export const PlasmicMinting__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export const PlasmicMinting__ArgProps = new Array(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
function PlasmicMinting__RenderFunc(props) {
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__lDgP9)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__muIk)}
                role={"img"}
              />
            ),
...
function makeNodeComponent(nodeName) {
  const func = function (props) {
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicMinting__ArgProps,
      internalVariantPropNames: PlasmicMinting__VariantProps
    });

    return PlasmicMinting__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicMinting";
  } else {
    func.displayName = `PlasmicMinting.${nodeName}`;
  }
  return func;
}

export const PlasmicMinting = Object.assign(
  // Top-level PlasmicMinting renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicMinting
    internalVariantProps: PlasmicMinting__VariantProps,
    internalArgProps: PlasmicMinting__ArgProps,
    useBehavior
  }
);

export default PlasmicMinting;
/* prettier-ignore-end */
