...
import sty from "./PlasmicGalleryLegacy.module.css"; // plasmic-import: CFz-I9uXMp/css
...
export const PlasmicGalleryLegacy__VariantProps = new Array();

export const PlasmicGalleryLegacy__ArgProps = new Array("selected");

export const defaultGalleryLegacy__Args = {};

function PlasmicGalleryLegacy__RenderFunc(props) {
  const { variants, overrides, forNode } = props;
  const args = Object.assign({}, defaultGalleryLegacy__Args, props.args);
  const $props = args;
...
function makeNodeComponent(nodeName) {
  const func = function (props) {
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicGalleryLegacy__ArgProps,
      internalVariantPropNames: PlasmicGalleryLegacy__VariantProps
    });

    return PlasmicGalleryLegacy__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicGalleryLegacy";
  } else {
    func.displayName = `PlasmicGalleryLegacy.${nodeName}`;
  }
  return func;
}

export const PlasmicGalleryLegacy = Object.assign(
  // Top-level PlasmicGalleryLegacy renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicGalleryLegacy
    internalVariantProps: PlasmicGalleryLegacy__VariantProps,
    internalArgProps: PlasmicGalleryLegacy__ArgProps
  }
);

export default PlasmicGalleryLegacy;
/* prettier-ignore-end */
