...
import sty from "./PlasmicDiscoverButton.module.css"; // plasmic-import: XuXn_eVAMfJ/css
...
export const PlasmicDiscoverButton__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export const PlasmicDiscoverButton__ArgProps = new Array(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
function PlasmicDiscoverButton__RenderFunc(props) {
  ...
  return (
    ...
    >
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___6BfMn)}
                role={"img"}
              />
            ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: "Discover his journey",
          value: args.children,
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__klrUw)}
                role={"img"}
              />
            ),
...
function makeNodeComponent(nodeName) {
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicDiscoverButton";
  } else {
    func.displayName = `PlasmicDiscoverButton.${nodeName}`;
  }
  return func;
}

export const PlasmicDiscoverButton = Object.assign(
  // Top-level PlasmicDiscoverButton renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicDiscoverButton
    internalVariantProps: PlasmicDiscoverButton__VariantProps,
    internalArgProps: PlasmicDiscoverButton__ArgProps,
    useBehavior
  }
);

export default PlasmicDiscoverButton;
/* prettier-ignore-end */
