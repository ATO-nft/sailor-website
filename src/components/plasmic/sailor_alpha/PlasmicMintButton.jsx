...
import sty from "./PlasmicMintButton.module.css"; // plasmic-import: GeHxaxYhV01/css
...
export const PlasmicMintButton__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export const PlasmicMintButton__ArgProps = new Array(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
function makeNodeComponent(nodeName) {
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicMintButton";
  } else {
    func.displayName = `PlasmicMintButton.${nodeName}`;
  }
  return func;
}

export const PlasmicMintButton = Object.assign(
  // Top-level PlasmicMintButton renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicMintButton
    internalVariantProps: PlasmicMintButton__VariantProps,
    internalArgProps: PlasmicMintButton__ArgProps,
    useBehavior
  }
);

export default PlasmicMintButton;
/* prettier-ignore-end */
